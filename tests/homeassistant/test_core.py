...
async def test_start(
    ...
    with (
        ...
        assert run.call_args.args[0] == "ghcr.io/esaueng/generic-x86-64-homeassistant"
...
async def test_core_loads_wrong_image_for_machine(
    ...
    with patch.object(
        ...
        pull_image.assert_called_once_with(
            ANY,
            "ghcr.io/esaueng/generic-x86-64-homeassistant",
            "2024.4.0",
...
async def test_core_loads_wrong_image_for_architecture(
    ...
    container.delete.assert_called_once_with(force=True, v=True)
    assert coresys.docker.images.delete.call_args_list[0] == call(
        "ghcr.io/esaueng/generic-x86-64-homeassistant:latest",
        force=True,
    )
    assert coresys.docker.images.delete.call_args_list[1] == call(
        "ghcr.io/esaueng/generic-x86-64-homeassistant:2024.4.0",
        force=True,
    )
    assert coresys.homeassistant.image == "ghcr.io/esaueng/generic-x86-64-homeassistant"
