...
async def test_api_set_image(
    ...
    api_client, root = core_api_client_with_root
    assert coresys.homeassistant.image == "ghcr.io/esaueng/generic-x86-64-homeassistant"
    ...
    with patch.object(HomeAssistant, "save_data"):
        resp = await api_client.post(
            f"{root}/options",
            json={"image": "ghcr.io/esaueng/generic-x86-64-homeassistant"},
        )
...
async def test_config_check(
    ...
    coresys.docker.containers.create.assert_called_once_with(
        {
            "Image": "ghcr.io/esaueng/generic-x86-64-homeassistant:2025.1.0",
...
async def test_update_skips_health_check_when_core_not_running(
    ...
    coresys.homeassistant.set_image("ghcr.io/esaueng/generic-x86-64-homeassistant")
    ...
    with (
        ...
        patch.object(
            ...
            "image_homeassistant",
            new=PropertyMock(
                return_value="ghcr.io/esaueng/generic-x86-64-homeassistant"
            ),
        ),
        patch.object(
            DockerHomeAssistant,
